...
function(_userver_codegen_make_target)
  get_property(userver_codegen_files GLOBAL PROPERTY userver_codegen_files)
  add_custom_target(
      userver-codegen
...
function(_userver_codegen_register_files FILES_LIST)
  ...
  get_property(has_userver_codegen_files GLOBAL PROPERTY userver_codegen_files SET)
  if(NOT has_userver_codegen_files AND FILES_LIST)
    # On first codegen files added, schedule userver-codegen target creation.
    cmake_language(
        DEFER
        DIRECTORY "${CMAKE_SOURCE_DIR}"
        ID userver_codegen_make_target
        CALL _userver_codegen_make_target
    )
  endif()

  set_property(GLOBAL APPEND PROPERTY userver_codegen_files ${FILES_LIST})
endfunction()
